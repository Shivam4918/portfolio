...
def send_contact_emails_async(name, email, subject, message):
    def send_task():
        ...
        try:
            ...
            email_msg.send()
            logger.info("Notification HTML email successfully sent to shivam4918@gmail.com.")
        except Exception as e:
            logger.error(f"Failed to send email notification to Shivam: {str(e)}")
        ...
        try:
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="btn-wrapper">
                            <a href="http://localhost:8000" class="btn">Visit My Portfolio</a>
                        </div>
                        <div class="signature">
            ...
            email_msg.send()
            logger.info(f"Auto-reply HTML email successfully sent to {email}.")
        except Exception as e:
            logger.error(f"Failed to send auto-reply email to visitor {email}: {str(e)}")
