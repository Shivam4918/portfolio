      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mt-8">
          ...
          >
            <div className="flex flex-col gap-4">
              {contactMethods.map((method) => (
                <a 
                  ...
                  rel="noreferrer"
                  className="glass-card-3d hover:border-[#6366F1]/50 p-5 flex items-center gap-4 text-left transition-all duration-300 hover:bg-[#6366F1]/5 glow-indigo-hover border-slate-200/50 dark:border-white/10 w-full"
                >
            ...
            {/* Resume CTA inside Left Column */}
            <div className="text-center lg:text-left mt-2">
              <a 
                href="/Resume1.pdf" 
                download="Prajapati_Shivam_Resume.pdf"
                className="inline-flex h-12 w-full lg:w-auto px-8 rounded-full bg-[#6366F1] hover:bg-[#6366F1]/90 text-white font-mono text-sm font-bold items-center justify-center gap-2.5 transition-all glow-indigo active:scale-95 cursor-pointer"
              >
          ...
          >
            <div className="glass-card-3d border border-slate-200/50 dark:border-white/10 p-6 sm:p-8 rounded-[18px] text-left backdrop-blur-xl">
        ...
        {/* Footer info & Credits */}
        <footer className="pt-10 mt-16 border-t border-slate-200/50 dark:border-white/5 flex flex-col items-center justify-center gap-4 text-center">
